function Footer() {
    return (
      <div className="w-full h-[100vh] bg-[#F1F1F1] pt-20 pb-5 px-20 flex items-start justify-around">
        <div className="w-1/3 h-full font-[founders] flex flex-col items-start justify-between">
          <div className="text">
            <h1 className="text-[12vw] tracking-light leading-[10vw] uppercase text-[#212121]">eye-</h1>
            <h1 className="text-[12vw] tracking-light leading-[10vw] uppercase text-[#212121]">opening</h1>
          </div>
          <svg
            width="72"
            height="30"
        ...
        <div className="w-1/2 h-fit">
          <h1 className="text-[10vw] leading-[9vw] uppercase font-[founders] mb-10 text-[#212121] ">presentation</h1>
          <div className="heading uppercase font-semibold text-2xl">
              <h2>facebook</h2>
              <h2>twitter</h2>
              <h2>INSTAGRAM</h2>
          </div>
